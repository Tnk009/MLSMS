...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Mthira Liquors Sales System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'sales')? 'active' : '' ?>" href="./?page=sales">Cash Sales</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'credit_sales')? 'active' : '' ?>" href="./?page=credit_sales">Credit Sales</a>
                    </li>
                    <li class="nav-item">
